...
func (mc *MemberCreate) SetPasswordHash(s string) *MemberCreate {
	mc.mutation.SetPasswordHash(s)
	return mc
}

// SetStatus sets the "status" field.
func (mc *MemberCreate) SetStatus(s string) *MemberCreate {
...
func (mc *MemberCreate) check() error {
	...
	if _, ok := mc.mutation.PasswordHash(); !ok {
		return &ValidationError{Name: "password_hash", err: errors.New(`ent: missing required field "Member.password_hash"`)}
	}
...
func (mc *MemberCreate) createSpec() (*Member, *sqlgraph.CreateSpec) {
	...
	if value, ok := mc.mutation.PasswordHash(); ok {
