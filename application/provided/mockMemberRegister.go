...
//
//	mockgen -source=application/provided/memberRegister.go -destination=application/provided/mockMemberRegister.go -package provided
//
...
func (m *MockMemberRegister) Activate(ctx context.Context, memberId string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Activate", ctx, memberId)
	ret0, _ := ret[0].(error)
	return ret0
}

// Activate indicates an expected call of Activate.
func (mr *MockMemberRegisterMockRecorder) Activate(ctx, memberId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Activate", reflect.TypeOf((*MockMemberRegister)(nil).Activate), ctx, memberId)
}

// Find mocks base method.
func (m *MockMemberRegister) Find(ctx context.Context, memberID int) (*domain.Member, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMemberRegisterMockRecorder) Find(ctx, memberID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Find", reflect.TypeOf((*MockMemberRegister)(nil).Find), ctx, memberID)
}
